...
var AnsibleTemplate string = `# This value determines how kubernetes binaries, config files, and service
...
kube_regitry: "registry.cn-hangzhou.aliyuncs.com/cheyang"

kubelet_options: 
  - "--pod-infra-container-image={{kube_regitry}}/google_containers/pause:2.0"

insecure_registrys:
  - "{{ kube_regitry }}"

flannel_opts: "-public-ip={{ inventory_hostname }}"
